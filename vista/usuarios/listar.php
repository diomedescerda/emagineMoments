        ...
        <?php foreach ($usuarios as $usuario): ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="index.php?action=eliminarUsuario&id=<?= $usuario['IdUsuario'] ?>&IdRol=<?=$usuario['IdRol'] ?>" onclick="return confirm('¿Estás seguro de eliminar este usuario?')">Eliminar</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
