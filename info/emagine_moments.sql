  ...
  --
  -- Host: 127.0.0.1
  -- Generation Time: Nov 13, 2024 at 01:12 PM
  ...
  (2, 18, 4, '2024-11-07 15:22:57'),
  (3, 18, 8, '2024-11-07 15:23:00'),
  (4, 18, 9, '2024-11-07 15:23:02'),
  (5, 18, 9, '2024-11-07 15:23:04'),
  (6, 18, 2, '2024-11-07 15:24:40');
  ...
  INSERT INTO `reviews` (`IdReview`, `IdCliente`, `IdContrato`, `Comentario`, `Calificacion`) VALUES
  (1, 18, 2, 'Me parecio muy bueno', 5),
  (2, 18, 4, 'tambien muy bueno', 5);
  ...
  (2, 1, 10, 1000.00, 'Prueba2'),
  (4, 2, 10, 500.00, 'yoque se'),
  (8, 1, 13, 1000.00, 'probando'),
  (9, 1, 10, 10000.00, 'Concierto');
