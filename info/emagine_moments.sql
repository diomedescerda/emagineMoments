...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2024 at 12:23 AM
...
(2, 1, 10, 1000.00, 'Prueba'),
(4, 2, 10, 500.00, 'yoque se'),
(8, 1, 13, 1000.00, 'probando');
...
(2, 1, 'Diomedes', 'Farid', 'Cerda', 'Leon', 'diomedes@admin.com', '$2y$10$3QTKCLi7g.d06oQ0us4cK.V0BCpqGqcDC9zfBX.9fxT5Gl1tou3L2', 'Carrera 53 # 70 - 86', '3010000000'),
(10, 3, 'Mauricio', 'Elias', 'Polo', 'Martinez', 'mauri@gmail.com', '$2y$10$mCWWLJqRnk4mPvauNqAPvuNjbIXfcA3zxsqqZ/H3xkkd.6VtoBDRi', 'Carrera 53 # 70 - 86', '3010000001'),
...
--
ALTER TABLE `tiposestadocontrato`
  MODIFY `IdTipoEstadoContrato` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `reseñas`
  ADD CONSTRAINT `reseñas_ibfk_1` FOREIGN KEY (`IdCliente`) REFERENCES `clientes` (`IdCliente`),
  ADD CONSTRAINT `reseñas_ibfk_2` FOREIGN KEY (`IdContrato`) REFERENCES `contratos` (`IdContrato`);
